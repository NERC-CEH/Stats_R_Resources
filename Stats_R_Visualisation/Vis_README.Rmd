...
You can execute each of the chunks using the little play button on each section of code.
...
All the data you need should be included in this folder. You will need to edit the working directory at the start of each script.
